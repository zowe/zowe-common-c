...
const char *CMS_RC_DESCRIPTION[] = {
  [RC_CMS_OK] = "Ok",
  [RC_CMS_ERROR] = "Error",
  [RC_CMS_PARM_NULL] = "Empty PC handler parameter",
  [RC_CMS_PARM_BAD_EYECATCHER] = "Parameter has invalid eyecatcher",
  [RC_CMS_FUNCTION_ID_OUT_OF_RANGE] = "Server ID is out of range",
  [RC_CMS_GLOBAL_AREA_NULL] = "Global area address is NULL",
  [RC_CMS_GLOBAL_AREA_BAD_EYECATCHER] = "Global area has bad eyecatcher",
  [RC_CMS_SERVER_NULL] = "Server address is NULL",
  [RC_CMS_FUNCTION_NULL] = "Service function address is NULL",
  [RC_CMS_AXSET_FAILED] = "PC-ss not set, AXSET failed",
  [RC_CMS_LXRES_FAILED] = "PC-ss/cp not set, LXRES failed",
  [RC_CMS_ETCRE_FAILED] = "PC-ss/cp not set, build entry table failed",
  [RC_CMS_ETCON_FAILED] = "PC-ss/cp not set, ETCON failed",
  [RC_CMS_DUPLICATE_SERVER] = "A duplicate server is running",
  [RC_CMS_ISGENQ_FAILED] = "Server not locked",
  [RC_CMS_ECSA_ALLOC_FAILED] = "Resource manager ECSA storage not allocated",
  [RC_CMS_NAME_TOKEN_CREATE_FAILED] = "Name/Token create failed",
  [RC_CMS_SERVER_NOT_AVAILABLE] = "Server not reachable",
  [RC_CMS_NAME_TOKEN_NOT_FOUND] = "Name/Token not found",
  [RC_CMS_NAME_TOKEN_BAD_EYECATCHER] = "Name/Token has bad eyecatcher",
  ...
  [RC_CMS_NAME_TOKEN_DELETE_FAILED] = "Name/Token delete failed", 
  [RC_CMS_RACF_ROUTE_LIST_FAILED] = "RACF route list failed ",
  ...
  [RC_CMS_ZVTE_NOT_ALLOCATED] = "ZVTE is not allocated",
  ...
  [RC_CMS_USER_PARM_NULL] = "User parameter is NULL",
  [RC_CMS_PC_HDLR_PARM_BAD_EYECATCHER] = "PC handler parameter has invalid eyecatcher",
  [RC_CMS_ZERO_PC_NUMBER] = "Zero PC number",
  [RC_CMS_WRONG_CLIENT_VERSION] = "Wrong client version",
  [RC_CMS_ZVTE_CHAIN_LOOP] = "",
  ...
  [RC_CMS_UNKNOWN_PARM_TYPE] = "Config parameter type is not known",
  ...
  [RC_CMS_STDSVC_PARM_NULL] = "Service parameter is NULL",
  [RC_CMS_STDSVC_PARM_BAD_EYECATCHER] = "Service parameter has invalid eyecatcher",
  [RC_CMS_NOT_APF_AUTHORIZED] = "Not APF-authorized",
  [RC_CMS_NO_STEPLIB] = "STEPLIB not found",  
  [RC_CMS_MODULE_NOT_IN_STEPLIB] = "Module not found in STEPLIB",
  [RC_CMS_SERVER_NAME_NULL] = "Server name is NULL",
  [RC_CMS_SERVICE_ENTRY_OCCUPIED] = "Service entry occupied",
  [RC_CMS_NO_STORAGE_FOR_MSG] = "No storage available for msg",  
