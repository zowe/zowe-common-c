...
## `3.6.0`
- Chore: configmgr and the REXX configmgr build take QuickJS from `zowe/quickjs-portable` `staging`, the Open Mainframe Project home of the z/OS port, instead of a personal fork.
