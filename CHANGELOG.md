...
## `3.6.0`
- Bugfix: a native class constructor that fails (for example `makeConfigManager()` returning NULL since #674) now raises a JavaScript `InternalError` naming the class, instead of returning an exception with no value. [(#676)](https://github.com/zowe/zowe-common-c/issues/676)
