...
void respondWithDataset(HttpResponse* response, char* absolutePath, int jsonMode, HttpService* service);
void updateDataset(HttpResponse* response, char* absolutePath, int jsonMode, HttpService* service);
